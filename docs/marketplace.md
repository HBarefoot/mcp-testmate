...
- [x] Tagged release exists (v0.3.0)
...
1. Go to the repo → **Releases** → edit **v0.3.0** (or draft the next release).
...
- Users should pin `@v0.3.0` (the README example already does). Consider maintaining a floating `v0` major tag once the interface stabilizes: `git tag -f v0 && git push -f origin v0`.
